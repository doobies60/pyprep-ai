...
【絶対ルール】問題文・選択肢・解説はすべて日本語で記述すること。英語の選択肢（YES/NO/True/Falseなど）は使用禁止。
...
・問題文に含めるコードは、空白行やコメントを極力省き、**必ず10行以内**に収めること。長くなる場合はロジックを簡潔にすること。
...
8. explanation（全体解説）のルール:
    - **全体を100文字程度の簡潔な文章**にまとめること。
    - 必要に応じて短いコード例を含めてもよいが、長くなりすぎないように注意すること。
...
9. JSON形式で出力:
    ...
    "explanation": "チュートリアルの記述に基づいた【100文字程度の簡潔な解説】",
